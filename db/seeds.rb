...
product1 = Product.create(title:"iPhone 14" , description: "SIM-Free, Model A19211 6.5-inch Super Retina HD display with OLED technology A12 Bionic chip", price: 89000, image_url: "https://images.unsplash.com/photo-1591815302525-756a9bcc3425?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTJ8fGlwaG9uZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" , stock:10 , vendor_id:1 )
