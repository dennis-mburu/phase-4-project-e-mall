  ...
  if (cart.length === 0) return (
    <>
      <div className='text-center'>
        ...
        <button className='bg-transparent hover:bg-blue-500 mt-5  py-2 px-4 border border-blue-500 hover:border-transparent rounded"'
    ...
    <table className="w-full text-lg text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          {cart.map(order => (
           ...
           src={order.product_image} alt="product" ></img>
           </th>
            ...
            <td className="py-4 px-6">
            <button className=" bg-red-800 text-white hover:bg-red-900 mt-5  py-2 px-4 border border-red-400 hover:border-transparent rounded"
